...
| --- | --- | --- | --- | --- |
| Info | Informational | https://taskflow-app.rickdan.ddns-ip.net | Percentage of responses with status code 2xx | 62 % |
| Info | Informational | https://taskflow-app.rickdan.ddns-ip.net | Percentage of responses with status code 3xx | 37 % |
| Info | Informational | https://taskflow-app.rickdan.ddns-ip.net | Percentage of endpoints with content type text/html | 100 % |
| Info | Informational | https://taskflow-app.rickdan.ddns-ip.net | Percentage of endpoints with method GET | 66 % |
| Info | Informational | https://taskflow-app.rickdan.ddns-ip.net | Percentage of endpoints with method POST | 33 % |
| Info | Informational | https://taskflow-app.rickdan.ddns-ip.net | Count of total endpoints | 6    |
...
* URL: https://taskflow-app.rickdan.ddns-ip.net
  ...
  * Evidence: ``
  * Other Info: ``
* URL: https://taskflow-app.rickdan.ddns-ip.net/login.php
  * Node Name: `https://taskflow-app.rickdan.ddns-ip.net/login.php`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: ``
  * Other Info: ``
* URL: https://taskflow-app.rickdan.ddns-ip.net/register.php
  * Node Name: `https://taskflow-app.rickdan.ddns-ip.net/register.php`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: ``
  * Other Info: ``
* URL: https://taskflow-app.rickdan.ddns-ip.net/login.php
  * Node Name: `https://taskflow-app.rickdan.ddns-ip.net/login.php ()(csrf_token,identifier,password)`
  * Method: `POST`
  * Parameter: ``
  * Attack: ``
  * Evidence: ``
  * Other Info: ``
* URL: https://taskflow-app.rickdan.ddns-ip.net/register.php
  * Node Name: `https://taskflow-app.rickdan.ddns-ip.net/register.php ()(confirm_password,csrf_token,email,password,username)`
  * Method: `POST`
  * Parameter: ``
  * Attack: ``
  * Evidence: ``
...
* URL: https://taskflow-app.rickdan.ddns-ip.net
  ...
  * Parameter: ``
  * Attack: ``
  * Evidence: `<link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet">`
  * Other Info: ``
* URL: https://taskflow-app.rickdan.ddns-ip.net
  * Node Name: `https://taskflow-app.rickdan.ddns-ip.net`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">`
  * Other Info: ``
* URL: https://taskflow-app.rickdan.ddns-ip.net/login.php
  * Node Name: `https://taskflow-app.rickdan.ddns-ip.net/login.php`
  * Method: `GET`
...
https://taskflow-app.rickdan.ddns-ip.net/login.php

appears to include user input in:
a(n) [input] tag [value] attribute

The user input found was:
csrf_token=deec692986aad45e7154f2fd5e3829b8501843b3b5d1d515ca65073114afe762

The user-controlled value was:
deec692986aad45e7154f2fd5e3829b8501843b3b5d1d515ca65073114afe762`
* URL: https://taskflow-app.rickdan.ddns-ip.net/register.php
  * Node Name: `https://taskflow-app.rickdan.ddns-ip.net/register.php ()(confirm_password,csrf_token,email,password,username)`
  * Method: `POST`
...
https://taskflow-app.rickdan.ddns-ip.net/register.php

appears to include user input in:
a(n) [input] tag [value] attribute

The user input found was:
confirm_password=ZAP
